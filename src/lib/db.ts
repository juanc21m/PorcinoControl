...
function animalToRow(a: Animal): Row {
  return clean({
    ...
    litter_males: a.litterMales ?? null,
    litter_females: a.litterFemales ?? null,
...
function rowToAnimal(r: Row): Animal {
  return {
    ...
    roomNumber: r.room_number === null || r.room_number === undefined ? undefined : Number(r.room_number),
    litterMales: r.litter_males === null || r.litter_males === undefined ? undefined : Number(r.litter_males),
    litterFemales: r.litter_females === null || r.litter_females === undefined ? undefined : Number(r.litter_females),
...
const ANIMAL_COL: Record<string, string> = {
  ...
  roomNumber: 'room_number', litterMales: 'litter_males', litterFemales: 'litter_females',
